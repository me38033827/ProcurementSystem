					...
					<div class="half inline-b">
						<table class="tab-height" id="supplier-crea-tab1">
							<tr>
								...
								<td class="supplier-crea-tab-col2"><input class="form-control input"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="supplier-crea-tab-col2"><textarea class="form-control" id="pr-textarea"></textarea>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="supplier-crea-tab-col2">（选择一个值）［&nbsp;<a class="blue inline-b">选择</a>&nbsp;］
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="supplier-crea-tab-col1">公司所在州／省：
								</td>
								<td class="supplier-crea-tab-col2"><input class="form-control input"/>
								</td>
							</tr>
					...
					<div class="half inline-b right">
						<div class="inline-b tab-height" id="supplier-crea-tab2">
							<table>
								...
								<tr>
									<td class="supplier-crea-tab-col1">主要传真：
									</td>
									<td class="supplier-crea-tab-col2"><input class="form-control input"/>
									</td>
								</tr>
								...
								<tr>
									<td class="supplier-crea-tab-col1">公司URL：
									</td>
									<td class="supplier-crea-tab-col2"><input class="form-control input"/>
									</td>
								</tr>
								...
								<tr>
									<td class="supplier-crea-tab-col1">组织类型：
									</td>
									<td class="supplier-crea-tab-col2"><input class="form-control input"/>
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">父级：
									</td>
									<td class="supplier-crea-tab-col2">
										<select id="my-select">
											<option>(无值)</option>
						...
						<tr class="searching-tab-row3">
							<td colspan="2">
								<div align="right">
									...
									<button class="btn-w" onclick="window.location.href='supplier-searching.html'">取消</button>
								</div>
							</td>
						</tr>
					</table>
