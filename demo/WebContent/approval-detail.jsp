	...
	<body>
		<div class="container" id="whole-container">
			...
			<div id="searching-title-out">
				...
				<div class="right"><button class="btn-w" onclick="window.location.href='approval-searching.html'">退出</button></div>
			</div>
			<div id="order-detail-main">
				...
				<div id="approval-last">
					<a class="black">要包含在CSV中的列（导出列表题以创建模版）</a>
					<a class="right black">已包含1列</a>
					<div id="approval-tab1-out">
						<table id="approval-tab1">
							...
							<tr id="approval-tab1-row2">
								...
								<td id="approval-tab1-row2-col2">
									<a class="black">审批人类型字段：</a>
									<div>
										<label class="approval-person-type">
										  <input type="checkbox" id="approval-person-type" value="option1"> 组
										</label>
										<label class="approval-person-type">
										  <input type="checkbox" id="approval-person-type" value="option2"> 审批人列表
										</label>
										<label class="approval-person-type">
										  <input type="checkbox" id="approval-person-type" value="option3"> 审批人字段路径
										</label>
										<label class="approval-person-type">
										  <input type="checkbox" id="approval-person-type" value="option4"> 用户
										</label>
									</div>
								</td>
								<td id="approval-tab1-row2-col3">
									<div class="btn-group">
										<button data-toggle="dropdown" class="btn btn-default dropdown-toggle" id="order-filter-select1">
											 小于&nbsp;&nbsp;&nbsp;&nbsp;
