		...
		<div class="container" id="whole-container">
			...
			<div id="order-detail-main">
				...
				<div class="inline-b" id="invoice-detail2-tab1">
					<table class="fulltab">
						<tr>
							<td class="invoice-crea-tab-col1">类型：
							</td>
							<td class="invoice-crea-tab-col2">
								<div class="radio">
									<a class="black"><label><input type="radio" name="multiple" id="optionsRadios1" value="option1">非PO</label></a>
								  	<a class="black"><label><input type="radio" name="multiple" id="optionsRadios2" value="option2" checked>基于PO</label></a>
								  	<a class="black"><label><input type="radio" name="multiple" id="optionsRadios1" value="option3">基于合同</label></a>
								</div>
							</td>
						</tr>
						<tr>
							<td class="invoice-crea-tab-col1">＊供应商：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>供应商1</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">供应商联系人：
							</td>
							<td class="invoice-crea-tab-col2">（无值）［&nbsp;<a class="blue inline-b">选择</a>&nbsp;］
							</td>
						</tr>
						
						<tr>
							<td class="invoice-crea-tab-col1">＊供应商发票编号：
							</td>
							<td class="invoice-crea-tab-col2"><input class="form-control input"/>
							</td>
						</tr>
						
						<tr>
							<td class="invoice-crea-tab-col1">发票日期：
							</td>
							<td class="invoice-crea-tab-col2"><input class="form-control input" value="2017年7月10日"/>
							</td>
						</tr>
						
						<tr>
							<td class="invoice-crea-tab-col1">＊订购单：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>(无值)</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">委托人：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>选项1</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">采购单位：
							</td>
							<td class="invoice-crea-tab-col2">CN01
							</td>
						</tr>
						
						<tr>
							<td class="invoice-crea-tab-col1">公司代码：
							</td>
							<td class="invoice-crea-tab-col2">CN01
							</td>
						</tr>
						...
						<tr>
							<td class="invoice-crea-tab-col1">税号：
							</td>
							<td class="invoice-crea-tab-col2">
							</td>
						</tr>
						...
						<tr>
							<td class="invoice-crea-tab-col1">支付方式：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>(无值)</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">Has WHT：
							</td>
							<td class="invoice-crea-tab-col2">
								<div class="radio">
						...
						<tr>
							<td class="invoice-crea-tab-col1">原系统名称：
							</td>
							<td class="invoice-crea-tab-col2"><input class="form-control input"/>
							</td>
						</tr>	
						<tr>
							<td class="invoice-crea-tab-col1">我的标签：
							</td>
							<td class="invoice-crea-tab-col2"><div class="blue">应用标签...<span class="caret"></span></div>
							</td>
						</tr>
					</table>
				</div>
				<div class="inline-b" id="invoice-detail2-tab2">
					<table>
						<tr>
							<td class="invoice-crea-tab-col1">付款条件：
							</td>
							<td class="invoice-crea-tab-col2">（无值）
							</td>
						</tr>
						
						<tr>
							<td class="invoice-crea-tab-col1">发货地址：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>(无值)</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">车间：
							</td>
							<td class="invoice-crea-tab-col2">＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊
							</td>
						</tr>
						<tr>
							<td class="invoice-crea-tab-col1">收款人地址：
							</td>
							<td class="invoice-crea-tab-col2">
								<select id="my-select">
									<option>(无值)</option>
						...
						<tr>
							<td class="invoice-crea-tab-col1">＊交付地址：
							</td>
							<td class="invoice-crea-tab-col2"><input class="form-control input"/>
							</td>
						</tr>
