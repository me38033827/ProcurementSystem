		...
		<div class="container" id="whole-container">
			...
			<div id="order-detail-main">
				...
				<div id="order-detail-line3">
					<button class="btn-w" onclick="window.location.href='order-searching.html'">关闭</button>
					<button class="btn-w">打印</button>
					<button class="btn-w">创建预付款</button>
				</div>
				<div id="order-detail-line4">
					<button class="order-detail-clicked">摘要</button>
					<button class="order-detail-not-clicked" onclick="window.location.href='order-detail-approval.html'">审批流程</button>
					<button class="order-detail-not-clicked" onclick="window.location.href='order-detail-delivery.html'">物流</button>
					...
					<button class="order-detail-not-clicked" onclick="window.location.href='order-detail-goods-receipt.html'">历史记录</button>
				</div>
				<div id="order-detail-tab">
					<table>
						<tr>
							...
							<td id="order-detail-tab-col2">10000081
							</td>
						</tr>
						
						<tr>
							<td id="order-detail-tab-col1">版本：
							</td>
							<td id="order-detail-tab-col2">1
							</td>
						</tr>
						
						<tr>
							<td id="order-detail-tab-col1">标题：
							</td>
						...
						<tr>
							<td id="order-detail-tab-col1">采购单位：
							</td>
							<td id="order-detail-tab-col2">0001
							</td>
						</tr>
						...
						<tr>
							...
							<td id="order-detail-tab-col2">UAT-01
							</td>
						</tr>
						
						<tr>
							<td id="order-detail-tab-col1">联系人：
							</td>
							<td id="order-detail-tab-col2">UAT-01
							</td>
						</tr>
						...
						<tr>
							<td id="order-detail-tab-col1">关闭订单：
							</td>
							<td id="order-detail-tab-col2">打开
							</td>
						</tr>
						...
						<tr>
							...
							<td id="order-detail-tab-col2">PRC
							</td>
						</tr>
						
						<tr>
							<td id="order-detail-tab-col1">国家：
							</td>
						...
						<tr>
							<td id="order-detail-tab-col1">原系统采购订单号：
							</td>
							<td id="order-detail-tab-col2">
							</td>
						</tr>
						...
						<tr>
							<td id="order-detail-tab-col1">订单方式：
							</td>
							<td id="order-detail-tab-col2">邮件
							</td>
						</tr>
