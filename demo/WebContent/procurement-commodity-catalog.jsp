	...
	<body>
		<div class="container" id="whole-container">
			...
			<div id="thirdline-out">
				...
				<!-- 第三行右侧图标 -->
				<button class="btn-w right" style="margin-right:20px;" onclick="window.location.href='procurement-catalog.html'">目录管理</button>
			...
			<div class="main-subjects">
				<!-- 右侧过滤栏 -->
				<div id="filter">
				 	<a class="filter-title" id="filter-first">过滤条件</a>
				 	<input type="text" class="inline-b border-g left col-md-8" value="在结果中搜索" style="font-size:12px;"
					...
					<div class="adjust"></div>
				 	<a class = "filter-title">合同</a>
				 	<a class = "filter-content">搜索合同</a>
				 	<a class = "filter-title">关键字</a>
				 	<a class = "filter-content">affairs(1)</a>
				 	<a class = "filter-content">civic(1)</a>
				 	<a class = "filter-content">description(1)</a>
				 	<a class = "filter-content">enter(1)</a>
				 	<a class = "filter-content">查看更多</a>
				 	<a class = "filter-title">类别</a>
				 	<a class = "filter-content">其他政治、公民事物服务(1)</a>
				 	<a class = "filter-content">其他制造业相关业务(3)</a>
				 	<a class = "filter-title">供应商</a>
					<a class = "filter-content">发发发发展有限公司(1)</a>
				 	<a class = "filter-content">有限责任公司(3)</a>
				</div>
				 ...
				 <div class="results-out col-md-8">
				 	...
				 	<div class="result-line2">
				 		<div class="result-line2-left"><a class="result-line2-font">找到3个项目。</a></div>
				 		<div class="result-line2-middle">
				 			<a class="result-line2-font">查看方式：</a>
				 			<span class="glyphicon glyphicon-list" aria-hidden="true" id="glyphicon-list"></span>
				 		</div>
				 		<div class="result-line2-right"><a class="result-line2-font">排序方式：相关性</a></div>
				 	</div>
				 	...
				 	<div class="result-items">
				 		...
				 		<div class = "result-item">
							...
							<div class = "item-whole">
						 		<a class = "item-content-blue" href="procurement-commodity-detail.html">产品1</a><br>
						 		<a class = "item-content-grey">供应商：</a>
						 		<a class = "item-content-blue">供应商1</a><br>
						 		<a class = "item-content-grey">供应商部件号：</a>
						 		<a class = "item-content-black">123</a><br>
						 		<a class = "item-content-grey">剩余时间：</a>
						 		<a class = "item-content-black">0天</a><br>
						 		<a class = "item-content-grey">合同：</a>
						 		<a class = "item-content-black">c123</a><br>
				 		...
				 		<div class = "result-item">
							...
							<div class = "item-whole">
						 		<a class = "item-content-blue">产品2</a><br>
						 		<a class = "item-content-grey">供应商：</a>
						 		<a class = "item-content-blue">供应商2</a><br>
						 		<a class = "item-content-grey">供应商部件号：</a>
						 		<a class = "item-content-black">124</a><br>
						 		<a class = "item-content-grey">剩余时间：</a>
						 		<a class = "item-content-black">0天</a><br>
						 		<a class = "item-content-grey">合同：</a>
						 		<a class = "item-content-black">c124</a><br>
						 		<a class = "item-content-black">描述</a>
					 		</div>
					 		
					 		<div class = "item-price">
					 			<a class = "item-price-green">329.00 CNY</a>
					 			<a class = "item-price-grey">&nbsp;／件</a><br>
					 			<a class = "item-price-black">数量：
					 				<input class="item-quantity" value = "1"/> 
					 				<button class="item-add">添加到购物车</button></a>
				 		...
				 		<div class = "result-item">
							...
							<div class = "item-whole">
						 		<a class = "item-content-blue">产品3</a><br>
						 		<a class = "item-content-grey">供应商：</a>
						 		<a class = "item-content-blue">供应商3</a><br>
						 		<a class = "item-content-grey">供应商部件号：</a>
						 		<a class = "item-content-black">125</a><br>
						 		<a class = "item-content-grey">剩余时间：</a>
						 		<a class = "item-content-black">0天</a><br>
						 		<a class = "item-content-grey">合同：</a>
						 		<a class = "item-content-black">c125</a><br>
						 		<a class = "item-content-black">描述</a>
					 		</div>
					 		
					 		<div class = "item-price">
					 			<a class = "item-price-green">432.00 CNY</a>
					 			<a class = "item-price-grey">&nbsp;／件</a><br>
					 			<a class = "item-price-black">数量：
					 				<input class="item-quantity" value = "1"/> 
					 				<button class="item-add">添加到购物车</button></a>
