		...
		<div class="container" id="whole-container">
			...
			<div id="order-detail-main-1">
				...
				<div id="order-detail-line4">
					...
					<button class="order-detail-not-clicked" onclick="window.location.href='template-detail-cond.html'">条件</button>
					...
					<div class="half inline-b">
						<div>
							...
							<table class="tab-height" id="supplier-crea-tab1">
								<tr>
									<td class="supplier-crea-tab-col1">名称：
									</td>
									<td class="supplier-crea-tab-col2">模版1
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="supplier-crea-tab-col2">原始
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">标识符：
									</td>
									<td class="supplier-crea-tab-col2">124123
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="supplier-crea-tab-col1">排名：
									</td>
									<td class="supplier-crea-tab-col2">10
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="supplier-crea-tab-col1">条件：
									</td>
									<td class="supplier-crea-tab-col2">
									</td>
								</tr>
						...
						<div>
							...
							<table class="tab-height fulltab" id="supplier-crea-tab1">
								<tr>
									<td class="supplier-crea-tab-col1">模版1     
									</td>
									<td class="supplier-crea-tab-col2">2017年7月18日 上午 11:55
									</td>
								</tr>
							</table>
						</div>
