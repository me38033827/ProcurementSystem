		...
		<div class="container" id="whole-container">
			...
			<div class="con">
				<div id="searching-title-out">
					...
					<button class="btn-w right" onclick="window.location.href='user-group-searching1.html'">完成</button>
				</div>
				<div class="user-main">
					 <!-- 搜索显示区域 -->
					 <div id="order-detail-line4">
						<button class="order-detail-clicked">常规</button>
						<button class="order-detail-not-clicked" onclick="window.location.href='user-group-detail-user.html'">用户</button>
