		...
		<div class="con">
			...
			<div class="user-main">
				...
				<div id="order-detail-line4">
					...
					<button class="order-detail-clicked" onclick="window.location.href='userCreationGroup.jsp'">组</button>
				</div>

				<div id="order-detail-line2">
					<a class="black">通过组，您可以根据用户执行的不同业务功能向其分配相应的权限。有关组的详细信息，请参阅单击“帮助”链接即可访问的用户手册。</a>
				</div>

				<div>
					<table class="fulltab">
						<tr class="searching-tab-row1">
							<td style="width:30%;">组名称</td>
							<td style="width:20%;">定义者</td>
