	...
	<body>
		<div class="container" id="whole-container">
			...
			<div class="main-subjects">
				<!-- 右侧 -->
				<div id="filter">
				 	<a id="order-filter-right-title">支付</a>
				 	...
				 	<div id="filters">
				 		...
				 		<div>
					 		<div class="left col-md-5 inline-b">
					 			<table>
					 				<tr>
					 					<td class="order-filter-left-col1">付款标识符：
					 					</td>
					 					<td class="order-filter-left-col2"><input class="form-control input"/>
					 					</td>
					 				</tr>
					 				<tr>
					 					<td class="order-filter-left-col1">银行账户：
					 					</td>
					 					<td class="order-filter-left-col2"><input class="form-control input"/>
					 					</td>
					 				</tr>
					 				<tr>
					 					<td class="order-filter-left-col1">银行地址：
					 					</td>
					 					<td class="order-filter-left-col2"><input class="form-control input"/>
					 					</td>
					 				</tr>
					 				...
					 				<tr>
					 					<td class="order-filter-left-col1">Swift code：
					 					</td>
					 					<td class="order-filter-left-col2"><input class="form-control input"/>
					 					</td>
					 				</tr>
					 		...
					 		<div align="right" class="inline-b col-md-5" >
					 			<table>
					 				...
					 				<tr>
					 					<td class="order-filter-left-col1">付款日期：
					 					</td>
