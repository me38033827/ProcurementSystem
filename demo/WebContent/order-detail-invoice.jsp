	...
	<div class="container" id="whole-container">
		...
		<div id="order-detail-main">
			...
			<div id="order-detail-line4">
				...
				<button class="order-detail-not-clicked"
					onclick="window.location.href='order-detail-invoice.jsp'">审批流程</button>
				<button class="order-detail-not-clicked"
					onclick="window.location.href='order-detail-delivery.jsp'">物流</button>
				<button class="order-detail-not-clicked"
					onclick="window.location.href='order-detail-goods-receipt.jsp'">收货</button>
				<button class="order-detail-not-clicked"
			...
			<div id="order-tab4-out">
				<table>
					...
					<tr id="order-tab4-row2">
						<td><a href="invoice-detail.jsp">INV123</a></td>
						<td>2017年7月5日（星期一）</td>
						<td>12938（UAT_123）</td>
						<td>UAT_123</td>
						<td>正在填写</td>
