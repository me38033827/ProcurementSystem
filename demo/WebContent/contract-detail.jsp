		...
		<div class="container" id="whole-container">
			...
			<div id="order-detail-main-1">
				...
				<div id="order-detail-line4">
					...
					<button class="order-detail-not-clicked" onclick="window.location.href='contract-detail-doc.html'">文档</button>
					...
					<div class="half inline-b">
						<div>
							...
							<table class="tab-height" id="supplier-crea-tab1">
								<tr>
									<td class="supplier-crea-tab-col1">合同标识符：
									</td>
									<td class="supplier-crea-tab-col2">C100569
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">合同状态：
									</td>
									<td class="supplier-crea-tab-col2">已发布
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">版本：
									</td>
									<td class="supplier-crea-tab-col2">v3
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="supplier-crea-tab-col2">中国 中国
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">访问控制：
									</td>
									<td class="supplier-crea-tab-col2">采购合同用户专用
									</td>
								</tr>
								<tr>
						...
						<div>
							<div class="invoice-detail-title">
								<a class="black">合同属性</a>
								<a class="right f-12">操作</a>
							</div>
							<table class="tab-height" id="supplier-crea-tab1">
								<tr>
									<td class="supplier-crea-tab-col1">相关标识符：
									</td>
									<td class="supplier-crea-tab-col2">
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">上次发布日期：
									</td>
									<td class="supplier-crea-tab-col2">2017年7月17日（您目前正在查看）
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">层级类型：
									</td>
									<td class="supplier-crea-tab-col2">独立合约
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">修正类型：
									</td>
									<td class="supplier-crea-tab-col2">修正
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">修正原因备注：
									</td>
									<td class="supplier-crea-tab-col2">＊＊＊＊＊＊＊＊
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">提议的合同金额：
									</td>
									<td class="supplier-crea-tab-col2">
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">合同金额：
									</td>
									<td class="supplier-crea-tab-col2">1 CNY
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">供应商：
									</td>
									<td class="supplier-crea-tab-col2">中建三局
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">受影响的相关者：
									</td>
									<td class="supplier-crea-tab-col2">中建三局
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">签约日期：
									</td>
									<td class="supplier-crea-tab-col2">2017年7月10日
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">流程状态：
									</td>
									<td class="supplier-crea-tab-col2">正在创建
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">预算系统：
									</td>
									<td class="supplier-crea-tab-col2">其他
									</td>
								</tr>
							</table>
						</div>
						...
						<div>
							<div class="invoice-detail-title">
								<a class="black">合同条款属性</a>
								<a class="right f-12">操作</a>
							</div>
							<table class="tab-height" id="supplier-crea-tab1">
								<tr>
									<td class="supplier-crea-tab-col1">期限类型：
									</td>
									<td class="supplier-crea-tab-col2">永久有效
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">系统有效日期：
									</td>
									<td class="supplier-crea-tab-col2">2017年7月27日
									</td>
								</tr>
								<tr>
									<td class="supplier-crea-tab-col1">失效日期：
									</td>
									<td class="supplier-crea-tab-col2">
									</td>
								</tr>
