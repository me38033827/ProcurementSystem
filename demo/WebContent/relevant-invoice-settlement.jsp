	...
	<div class="container" id="whole-container">
		...
		<div id="order-detail-main">
			<div class="relevant-pr-content">
				<a class="black">要浏览的类型：发票核算</a> <a class="black">选择的字段：（未选择字段）</a>
				<a class="black">字段数据类型：</a> <a class="black">字段说明</a>
			</div>
			...
			<div class="relevant-tab">
				<table>
					...
					<tr class="relevant-tab-row2">
						<td class="relevant-tab-col1 indent">公司代码</td>
						<td class="relevant-tab-col2">公司名称</td>
						<td class="relevant-tab-col3">无</td>
						<td class="relevant-tab-col4">选择</td>
					</tr>
					<tr class="relevant-tab-row2">
