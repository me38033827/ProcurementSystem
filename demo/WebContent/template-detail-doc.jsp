				...
				<div id="contract-detail-d">
					...
					<div class="right">
						...
						<div class="btn-group" role="group">
							<button type="button" id="manu-btns-dropdown-btn" class="btn btn-default dropdown-toggle blue" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div id="contract-detail-tab-doc">
						<table class="fulltab">
							...
							<tr class="searching-tab-row2">
								<td><a href="template-detail.html">模版1</a></td>
								<td>用户1</td>
								<td>（无）</td>
							</tr>
							<tr class="searching-tab-row2">
