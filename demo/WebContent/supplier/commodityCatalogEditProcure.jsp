		...
		<div id="order-detail-main">
			<div class="standard-title">
				...
				<div class="standard-title-r">
					...
					<button class="btn-w">验证并发布</button>
		...
		<div class="row">
			<div class="col-md-2">
				<div id="order-detail-main">
					<div class="commodity-catalog-edit-left left blue">
						...
						<button id="commodity-catalog-edit-left-clicked">3 订购</button>
						<button id="commodity-catalog-edit-left-not-clicked"></button>
						<button id="commodity-catalog-edit-left-not-clicked"></button>
						<button id="commodity-catalog-edit-left-not-clicked"></button>
						<button id="commodity-catalog-edit-left-not-clicked"></button>
			...
			<div class="col-md-10">
				<div class="container-padding">
					...
					<div>您可以通过电子邮件接收目录状态更新。要接收电子邮件，请单击管理概要，然后在“电子邮件通知”区域中输入邮件地址。</div>
					<br />
					<div>
						<table class="table">
							<tr>
					...
					<div>
						<table class="table">
							<tr>
								<td>可见性：</td>
								<td><div>
										<label><input type="radio"></label><strong>保密</strong>-只有与您具有合作关系的选定客户才能查看和接收目录
									</div>
									<div>
										<label> <input type="radio"></label> <strong>公开</strong>-所有客户都能查看目录。与您具有合作关系的客户还可以接收发布的目录
									</div></td>
							</tr>
						</table>
					</div>
