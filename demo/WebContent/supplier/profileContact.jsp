				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="tag-line">
							...
							<button class="tag-clicked" onclick="window.location.href='profileContact.jsp'">联系人</button>
							...
							<div class="adjust-left-80">
								<table>
									<tr class="row-standard">
										...
										<td class="col-standard2"><input style="width:240px;"class="form-control input" value="chendx@hp.com.cn"/></td>
									</tr>
									<tr class="row-standard">
									...
									<tr class="row-standard">
										...
										<td class="col-standard2">
											区号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号码<br>
											<input id="phone-prov" class="form-control input inline-b" style="width:60px;" value="010"/>
											<input id="phone-num" class="form-control input inline-b" value="57468223"/>
										</td>
									</tr>
								</table>
							</div>
