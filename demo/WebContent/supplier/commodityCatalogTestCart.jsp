		...
		<div id="order-detail-main">
			<div class="standard-title">
				...
				<div class="standard-title-r">
					<button class="btn-w" onclick="window.location.href='commodityCatalogTestPurchase.jsp'">上一步</button>
					<button class="btn-b" onclick="window.location.href='commodityCatalogTestOrder.jsp'">提交购物车</button>
			...
			<div class="col-md-2">
				<div id="order-detail-main">
					<div class="commodity-catalog-edit-left left blue">
						...
						<button id="commodity-catalog-edit-left-clicked" onclick="window.location.href='commodityCatalogTestCart.jsp'">2 提交购物车</button>
				...
				<div class="container-padding">
						...
						<table class="table table-hover">
							...
							<tr>
								<td width="5%" style="padding:5px;">
									<input type="checkbox" id="commo-c1" class="chk" /><label for="commo-c1"></label>
								</td>
								<td>SU0000134</td>
								<td>激光打印机PRI05</td>
								<td style="padding:3px;"><input class="commo-amount" value="1" /></td>
								<td>¥799.00</td>
								<td>台</td>
								<td>¥799.00</td>
							</tr>
							<tr>
								<td width="5%" style="padding:5px;">
									<input type="checkbox" id="commo-c2" class="chk" /><label for="commo-c2"></label>
								</td>
								<td>SU0000134</td>
								<td>彩色打印机PRI03</td>
								<td style="padding:3px;"><input class="commo-amount" value="1" /></td>
							...
							<tr class="standard-row3">
								<td colspan="7">
									...
									｜
									<button class="btn-w">更新数量</button>
								</td>
							</tr>
						</table>
					</div>
					<div class="table-container">
						<div class="commo-cart-r">
							<div class="row">
								<div class="col-md-6">
									<div class="commo-abstract"><b>购物车摘要</b></div>
								</div>
								<div class="col-md-6">
