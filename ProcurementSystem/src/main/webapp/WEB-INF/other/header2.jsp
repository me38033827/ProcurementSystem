...
<div class="container" id="secondline-out" style="width:100%">
	<div class="dropdown" id="secondline-dropdown">
		<!-- 第二行靠左 -->
		<button class="secondline-left" onclick="window.location.href='/ProcurementSystem/buyer/main'">主页</button>
		...
		<button class="secondline-left" onclick="window.location.href='/ProcurementSystem/buyer/mainSupplier'">供应商</button>
		...
		<div class="btn-group secondline" role="group">
			...
			<ul class="dropdown-menu" id="secondline-dropright">
				...
				<li><a class="secondline-right"
					href="commodityCatalogList">商品目录</a></li>
