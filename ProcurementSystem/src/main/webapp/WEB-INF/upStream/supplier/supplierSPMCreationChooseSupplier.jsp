					...
					<div class="searching-ending">
						<div align="right">
							...
							<button class="btn-w" form="empty"
								formaction="spmCreationChooseSupplier?action=reset">重置</button>
							<button class="btn-b" form="supplierSearch"
								formaction="spmCreationChooseSupplier?action=search">搜索</button>
						</div>
					</div>
				</div>
						...
						<c:forEach var="supplier" items="${suppliers}" varStatus="status">
							<tr>
								...
								<td style="width: 10%; padding: 3px;">
									<div align="right">
										<form method="post" action="spmGetSelectedSupplier">
