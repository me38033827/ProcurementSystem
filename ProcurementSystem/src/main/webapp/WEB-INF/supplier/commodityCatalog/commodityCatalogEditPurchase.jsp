		...
		<div id="order-detail-main">
			<div class="standard-title">
				...
				<div class="standard-title-r">
					...
					<button class="btn-b" type="submit" form="save">验证并发布</button>
			...
			<div class="col-md-10">
				<div class="container-padding">
					...
					<div>
						<table class="table">
							<tr>
								<td><strong>状态：</strong>已发布-${commodityCatalog.isDisplayed }</td>
								<td><strong>发布日期：</strong>${commodityCatalog.createDate }</td>
								<td><strong>${commodityCatalog.version }</strong></td>
							</tr>
						</table>
					</div>
					<br />
					<div>
						<form method="post" action="commodityCatalogEditValidateAndSave" id="save">
							<table class="table">
								<tr>
									<td>可见性：</td>
									<td><div>
											<label><input type="radio" name="isDisplayed" checked value="保密"></label><strong>
												保密</strong>-只有与您具有合作关系的选定客户才能查看和接收目录
										</div>
										<div>
											<label><input type="radio" name="isDisplayed" value="公开"></label><strong>
