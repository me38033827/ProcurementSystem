					...
					<div class="btn-group right">
						...
						<ul class="dropdown-menu manu-btn-o">
							...
							<li><a class="manu-active"
								href="templateSIMTaskPhaseCreate?parentId=${supplier.templateTaskTreeNode.id }">&nbsp;&nbsp;阶段</a></li>
							<li><a class="manu-active"
								href="templateSIMTaskScheduleCreate?parentId=${supplier.templateTaskTreeNode.id }">&nbsp;&nbsp;待办事项</a></li>
						</ul>
					</div>
				</div>
